...
cmd = 'cat ~/PATH/TO/FILE/asciiart/file{0}'.format(rng)
os.system(cmd)
...
sys.stdout.flush()
os.system("""~/PATH/TO/FILE/./ipsweep.sh 192.168.1""")
time.sleep(0.1)
print("\n\033[1;34;40mWeather Report:\033[0;37;40m")
sys.stdout.flush()
print("\033[1;36;40mCurrent:\033[0;37;40m\n")
os.system('python3 ~/PATH/TO/FILE/currweather.py')
sys.stdout.flush()
print("\033[1;36;40mForecast:\033[0;37;40m\n")
os.system('python3 ~/PATH/TO/FILE/weather.py')
